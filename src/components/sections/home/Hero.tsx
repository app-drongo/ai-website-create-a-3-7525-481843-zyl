...
export default function Hero() {
  ...
  const handlePrimaryAction = () => {
    router.push('/pricing'); // Lead to conversion/signup
  };
  ...
  const handleBadgeAction = () => {
    router.push('/features'); // Show new AI features
  };
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              ...
              InvoiceFlow helps small businesses get paid faster with automated billing solutions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.8/5 customer rating</span>
              </div>
            </div>
          </div>
                ...
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-4 bg-background rounded-lg shadow-lg p-6">
                    <div className="flex justify-between items-start mb-6">
                      <div>
                        <div className="h-8 w-32 bg-primary/20 rounded mb-2"></div>
                        <div className="h-4 w-24 bg-muted rounded"></div>
                      </div>
                      <div className="text-right">
                        <div className="h-6 w-20 bg-accent/20 rounded mb-1"></div>
                    ...
                    <div className="mt-6 pt-4 border-t border-muted">
                      <div className="flex justify-between">
                        ...
                        <div className="h-6 w-20 bg-primary/30 rounded"></div>
                      </div>
                    </div>
                  </div>
                </div>
