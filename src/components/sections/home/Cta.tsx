...
export default function Cta() {
  ...
  const handlePrimaryAction = () => {
    router.push('/pricing'); // Lead to conversion
  };
  const handleSecondaryAction = () => {
    router.push('/features'); // Provide more information
  };
  // ACTION_PLACEHOLDER_END

  const stats = [
    { value: '15K+', label: 'Invoices Sent', icon: Users },
    { value: '99.9%', label: 'Payment Success', icon: Shield },
    { value: '50+', label: 'Integrations', icon: Zap },
    { value: '2min', label: 'Setup Time', icon: Sparkles },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of small businesses who have automated their billing with
                InvoiceFlow. Create professional invoices, track payments, and get paid faster.
              </p>
