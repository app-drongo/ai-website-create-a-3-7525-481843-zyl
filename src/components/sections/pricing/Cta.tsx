...
import { ArrowRight, Sparkles, FileText, Shield, Clock } from 'lucide-react';
...
export default function Cta() {
  ...
  const stats = [
    { value: '15K+', label: 'Invoices Sent', icon: FileText },
    { value: '99.9%', label: 'Payment Success', icon: Shield },
    { value: '2min', label: 'Setup Time', icon: Clock },
    { value: '4.8★', label: 'User Rating', icon: Sparkles },
  ];
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center px-6 py-3 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary">
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join 5,000+ businesses using InvoiceFlow to create professional invoices in 30
                seconds. Start your 14-day free trial and experience the power of AI-driven
                invoicing.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by small businesses worldwide • Bank-level security • 150+ currencies
                  supported
                </p>
