...
import { ArrowRight, Sparkles, FileText, Clock, Shield } from 'lucide-react';
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join 5,000+ businesses who trust InvoiceFlow for their billing needs. Create
                professional invoices in 30 seconds and get paid faster.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by small businesses and freelancers worldwide
                </p>
