...
export default function Navigation() {
  ...
  const handleSignIn = () => {
    router.push('/pricing'); // Direct to pricing for conversion
  };

  const handleGetStarted = () => {
    router.push('/features'); // Showcase product capabilities first
  };
  // ACTION_PLACEHOLDER_END

  // Navigation items for invoice management platform
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button size="sm" className="group" onClick={handleGetStarted}>
              Get Started
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t border-muted">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              ...
              <Button className="justify-start group" onClick={handleGetStarted}>
                Get Started
                <ArrowRight className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
              </Button>
            </div>
